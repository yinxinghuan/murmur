...
- **Flow Bar**: 3 themes (Dark / Light / Outline), shows recording time, audio level, style badge, cancel button. Red state on paste failure
...
- **悬浮条**：3 种主题（深色 / 浅色 / 描边），显示录音时长、音频电平、风格标签、取消按钮。粘贴失败时变红
